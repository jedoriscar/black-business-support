...
# Loading Data ----
coding_manual <- read.csv("Data/Youtube/coding_manual.csv") 
...
# Saving the data ----
save(meta, file = here("Data/Youtube/meta.rda"))
save(vocab, file = here("Data/Youtube/vocab.rda"))
save(docs, file = here("Data/Youtube/docs.rda"))
