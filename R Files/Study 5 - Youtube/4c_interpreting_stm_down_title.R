...
datastm2_effects <- estimateEffect(1:63 ~ 1,  # Covariate: title
...
if (num_rows == nrow(datagamma)) {
  ...
  colnames(datagamma_combined)[(ncol(datagamma_combined)-62):ncol(datagamma_combined)] <- paste0("topic_", 1:63)
